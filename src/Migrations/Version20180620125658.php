 ...
 */
final class Version20180620125658 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_F6B4FB2928BD3759 ON membre (id_statut_membre_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_F6B4FB2928BD3759 ON membre');
    }
}
